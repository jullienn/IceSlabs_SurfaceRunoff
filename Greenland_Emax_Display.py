...
#Save the figure
plt.savefig('C:/Users/jullienn/Documents/working_environment/IceSlabs_SurfaceRunoff/Emax_VS_Iceslabs/whole_GrIS/'+str(desired_year)+'_EmaxMap_'+desired_map+'cleanedxytpdV2.pdf',dpi=300)
