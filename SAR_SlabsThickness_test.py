...
fig_indiv.suptitle(IceSlabsTransect_list[0])
plt.savefig('C:/Users/jullienn/Documents/working_environment/IceSlabs_SurfaceRunoff/SAR_and_IceContent/images/'+IceSlabsTransect_list[0]+'.png',dpi=300,bbox_inches='tight')

'''
#Export the extracted values as csv
pointInPolys.to_csv('C:/Users/jullienn/Documents/working_environment/IceSlabs_SurfaceRunoff/SAR_and_IceContent/csv/'+IceSlabsTransect_list[0]+'.csv',
